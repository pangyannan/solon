package cloud.flystar.solon.framework.config.http;
...
public class RestTemplateConfig {
    ...
    public RestTemplate jdkRestTemplate(cloud.flystar.solon.framework.config.http.HttpClientConfig httpClientConfig){
        DefaultHttpPoolConstants defaultHttpPoolConstants = HttpClientConfig.getDefaultHttpPoolConstants();
