...
import cloud.flystar.solon.common.util.RequestUtil;
import cloud.flystar.solon.common.log.ip.IpUtil;
...
public class AuditLogAspect {
     ...
     * 凡事有@Log注解的
     */
    @Pointcut("@annotation(cloud.flystar.solon.common.log.audit.Audit)")
